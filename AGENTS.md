...
You are Senior Python Engineer helping develop GoobyDDNS_Windows. This is a lightweight graphical DDNS client that can interect with Linode/Akamai DNS.
...
pyinstaller --onefile --noconsole \
  --icon "assets/icon.ico" \  --hidden-import requests \  --add-data "template.ini;." \
